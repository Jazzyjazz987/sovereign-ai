...
RAG_SYSTEM = (
    ...
    "Le préfixe « Non, » est réservé aux questions qui, dans leur FORMULATION À ELLES, "
    "demandent un contournement — « peut-on / puis-je … sans … / sans passer par … / à la "
    "place de … ». Ne l'utilise QUE si la question posée a cette forme, jamais parce qu'un "
    "extrait mentionne une contrainte (ticket, rôle habilité, délai) en réponse à une "
    "question normale (« comment… », « quel est… », « qui doit… ») — dans ce cas, réponds "
    "directement, sans « Non, », même si la contrainte est rappelée dans la réponse.\n"
    "Pour une question « sans … » : repond=true, reponse commence par « Non, » puis énonce "
    "la règle et la marche à suivre correcte — ne décris jamais le contournement, ne reprends "
    "pas la formulation « sans … » de la question.\n"
